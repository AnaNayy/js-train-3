...
// Задача 2: Напишіть функцію, яка визначає, чи є два числа майже однаковими,
//використовуючи Number.EPSILON
...
console.log("isAlmostSame(0.1 + 0.2, 0.3)", isAlmostSame(0.1 + 0.2, 0.3));
// Виведе true

// Задача 3: Напишіть функцію, яка перевіряє, чи є число безпечним
//цілим числом

function isSafeInteger(num) {
  // Перевіряємо, чи є число меншим або рівним MAX_SAFE_INTEGER і більшим
  // або рівним MIN_SAFE_INTEGER
...
// Задача 4: Використовуючи результати Задачі 3, напишіть функцію, яка
// перевіряє, чи є число небезпечним цілим числом

function isUnsafeInteger(num) {
  // Використовуємо логічну оператор НЕ (!), щоб отримати протилежну
  // відповідь від функції isSafeInteger()
...
// Задача 5: Напишіть функцію, яка перевіряє, чи є число надто великим
// для представлення в JavaScript
...
// Задача 6: Напишіть функцію, яка перевіряє, чи є число меншим чим
// найменше можливе числове значення в JavaScript

function isAlmostZero(num) {
  // Перевіряємо, чи є число більше 0, але все ще менше за Number.MIN_VALUE
  return 0 < num < Number.MIN_VALUE;
}
...
function checkIsInteger(num) {
  // Використовуємо вбудовану функцію Number.isInteger(), щоб перевірити,
  //чи є значення цілим числом
...
function checkIsSafeInteger(num) {
  // Використовуємо вбудовану функцію Number.isSafeInteger(), щоб перевірити,
  //  чи є значення безпечним цілим числом
...
function convertToExponential(num) {
  // Використовуємо метод toExponential(), щоб конвертувати число в
  // рядок з експоненційним представленням
...
// Задача 10: Напишіть функцію, яка конвертує число в рядок з фіксованою
// кількістю знаків після коми

function convertToFixed(num, precision) {
  // Використовуємо метод toFixed(), щоб конвертувати число в
  // рядок з фіксованою кількістю знаків після коми
